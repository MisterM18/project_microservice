    ...
    <div class="container">
        ...
        ?>
                ...
                <div>
                    <span class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="Button2">
                            ...
                            <li><a href="#" class="dropdown-item">ล่าสุด</a></li>
                            <li><a href="#" class="dropdown-item">อ่านบ่อยสุด</a></li>
                        </ul>
                    </span>
                </div>
            </div>
            ...
            <div class="card-header">
                <header style="color:#fff;">Last Post</header>
            </div>
            <br>
            <div class="card h-50 w-100 text-start">
                <div class="card-body text-left">
                    ...
                    <a href="contentboard.php" class="btn btn-primary">Read</a>
                </div>
            </div>
            ...
            <!-- use to connect data base category for board  -->
            <!-- <?php
